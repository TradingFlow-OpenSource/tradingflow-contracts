...
echo "使用的参数: $DEPLOYER_ADDRESS $PERSONAL_VAULT_IMPL_ADDRESS $DEPLOYER_ADDRESS"

# 验证工厂合约
npx hardhat verify --network flow $FACTORY_ADDRESS $DEPLOYER_ADDRESS $PERSONAL_VAULT_IMPL_ADDRESS $DEPLOYER_ADDRESS
